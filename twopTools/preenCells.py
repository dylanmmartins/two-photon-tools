...
preenCells
    Preen cells from suite2p output files.
_run_from_cmd
    Run preenCells from command line.

Example use
-----------
$ python -m twopTools.preenCells


Written by DMM, May 2023
"""
...
def preenCells(s2p_path, thresh_vals=None):
    ...
    thresh_vals : dict, optional
        Dictionary of threshold values for cell properties. If None, the
